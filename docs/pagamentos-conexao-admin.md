...
- Contas conectadas antes da inclusão do refresh token precisam reconectar uma vez para habilitar renovação automática. Credenciais legadas continuam utilizáveis; substituir manualmente um token remove o grant da conta anterior.
