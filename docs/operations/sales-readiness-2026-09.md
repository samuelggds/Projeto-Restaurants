...
| Open Finance Efí        | Integração implementada; homologação/configuração final pendente                                           | Não publicar para clientes até validar mTLS, webhook, retorno, expiração e devolução   |
| Asaas / Pagar.me        | Temporariamente indisponíveis                                                                               | Manter desativados até ativação futura                                                  |
