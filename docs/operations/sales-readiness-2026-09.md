...
| ----------------------- | ---------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| Mercado Pago            | Em produção                                                                                                | Comprovar fluxo completo no estabelecimento piloto e na cobrança da plataforma        |
| PagBank                 | Em análise de homologação                                                                                  | Não oferecer como operação homologada até aprovação do provedor e teste ponta a ponta |
...
O workflow **Payment Sandbox Preflight** valida somente autenticação/consulta do provedor escolhido. Falta de configuração nesse provedor falha explicitamente. Configurar segredos de teste no environment `payment-sandbox` do GitHub; nunca copiar os segredos de produção. PagBank/Asaas não selecionados não são tratados como homologados. Este preflight não substitui a lista de cenários acima.
