...
Em 21/09/2026 o responsável informou: backup externo configurado com restauração testada; Mercado Pago é o gateway ativo para Pix QR Code e cartão; Efí Open Finance permanece condicionado à configuração e homologação; Asaas e Pagar.me ficam desativados até homologação futura. Essas informações operacionais não substituem evidência de cada fluxo de pagamento. A revisão complementar e os passos de implantação estão em [sales-readiness-2026-09.md](operations/sales-readiness-2026-09.md).
