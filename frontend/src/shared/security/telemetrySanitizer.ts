...
export function limitTelemetryText(
  value: unknown,
...
function sanitizeValue(
  ...
  if (
    ...
    PAYMENT_KEY_PATTERN.test(normalizedKey)
  ) {
    return REDACTED;
  }
...
export function sanitizeTelemetryValue(
  ...
  const context: SanitizationContext = {
    maxStringLength: positiveIntegerOrDefault(options.maxStringLength, DEFAULT_MAX_STRING_LENGTH),
