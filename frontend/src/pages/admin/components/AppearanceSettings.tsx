    ...
    <S.SettingSection>
      <S.Card>
        ...
        <S.FormGrid>
          ...
          <S.Field>Fonte<select defaultValue="Inter"><option>Inter</option><option>Manrope</option><option>DM Sans</option></select></S.Field>
        </S.FormGrid>
      </S.Card>
      <S.Card>
        <h2>SEO da loja</h2>
        <S.FormGrid>
          <S.Field $full>Título da página<input defaultValue={`${settings.restaurantName} — Delivery`} /></S.Field>
          <S.Field $full>Descrição para buscadores<textarea defaultValue={settings.description} /></S.Field>
        </S.FormGrid>
      </S.Card>
    </S.SettingSection>
  );
