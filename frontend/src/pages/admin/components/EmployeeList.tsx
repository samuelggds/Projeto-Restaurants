  ...
  return (
    <S.Card>
      <S.EmployeeHeader>
        ...
        <button onClick={onNew}><Plus />Novo funcionário</button>
      </S.EmployeeHeader>
      <S.EmployeeList>
        {employees.map((employee) => (
          <S.EmployeeRow key={employee.id}>
            ...
            <div className="role">
              ...
              <span>{employee.role === "COOK" ? "Acessa a tela de cozinha" : employee.role === "WAITER" ? "Acessa a tela de garçom" : "Operação de pedidos"}</span>
            </div>
