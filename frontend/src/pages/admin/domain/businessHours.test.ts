...
describe('businessHours', () => {
  ...
  it('normaliza a agenda persistida', () =>
    expect(
      normalizeBusinessHours(
  ...
  it('não aceita fechamento anterior à abertura', () =>
    expect(
      validateBusinessHours([
        { ...defaultBusinessHours[0], openingTime: '23:00', closingTime: '11:00' },
      ]),
    ).toHaveProperty('monday'));
  it('gera o horário de hoje', () =>
    expect(getTodayBusinessHours(defaultBusinessHours, new Date('2026-08-10T12:00:00'))).toBe(
      'Hoje: 11:00 às 23:00',
    ));
