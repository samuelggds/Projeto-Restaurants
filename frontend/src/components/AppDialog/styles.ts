...
export const Dialog = styled.form`
  ...
  animation: app-dialog-card-in 220ms cubic-bezier(0.22, 0.8, 0.35, 1) both;
...
export const Actions = styled.footer`
  ...
  .confirm {
    ...
    background: #d64d08;
    color: #fff;
    box-shadow: 0 8px 20px #d64d082b;
  }
  .danger {
    border: 0;
    background: #b42318;
    color: #fff;
    box-shadow: 0 8px 20px #b4231828;
  }
