  ...
  waiter: [
    {
      ...
      steps: [
        'Objetivo: acompanhar em um só lugar pedidos prontos, mesas em atendimento e chamados pendentes do salão.',
    ...
    },
    {
      ...
      sidebarItems: ['Visão geral', 'Para entregar', 'Mesas e códigos', 'Chamados'],
      steps: [
        'Objetivo: conferir o estado das mesas e garantir que cada cliente acesse o cardápio digital da mesa correta.',
        'Acesse Mesas e códigos e localize a mesa pelo número ou pelo status apresentado.',
        'Confira se a mesa está ativa e se o código exibido corresponde à identificação física disponível no salão.',
        'Mostre o QR Code ao cliente e oriente-o a apontar a câmera, abrir o link e confirmar o número da mesa antes de pedir.',
        'Confirme o resultado verificando se o cardápio abriu e se a mesa correta aparece na tela do cliente.',
        'Acione o administrador se o código não abrir, direcionar para outra mesa, estiver ilegível ou a mesa precisar ser criada, ativada ou substituída.',
      ],
    },
    {
      id: 'calls',
