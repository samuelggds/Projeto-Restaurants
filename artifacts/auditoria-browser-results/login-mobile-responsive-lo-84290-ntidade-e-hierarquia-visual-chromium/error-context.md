...
- Name: login-mobile-responsive.spec.ts >> login desktop preserva identidade e hierarquia visual
- Location: e2e\login-mobile-responsive.spec.ts:74:1
...
Locator: getByTestId('login-cover')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('login-cover')
...
```ts
  ...
  3   | import { captureReadmeScreenshot } from './helpers/readmeScreenshot';
  4   | 
  5   | const LOGIN_COVER_URL = 'https://assets.test/north-cover.jpg';
  6   | const LOGIN_COVER_FILE = new URL('./fixtures/readme/pizza-margherita.jpg', import.meta.url);
  7   | 
  8   | const MOBILE_VIEWPORTS = [
  9   |   { name: '320x568', width: 320, height: 568 },
  10  |   { name: '360x740', width: 360, height: 740 },
  11  |   { name: '375x667', width: 375, height: 667 },
  12  |   { name: '390x844', width: 390, height: 844 },
  13  |   { name: '412x915', width: 412, height: 915 },
  14  |   { name: '430x932', width: 430, height: 932 },
