...
- Name: admin-orders-refund.spec.ts >> admin cancela Pix online com estorno único e distingue pagamento na entrega
- Location: e2e\admin-orders-refund.spec.ts:184:1
...
Locator: locator('article.order-card').filter({ hasText: '#701' })
Expected substring: "Cliente Pix Online"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('article.order-card').filter({ hasText: '#701' })
