...
test("calcula meses completos desde o início da assinatura", () => {
  ...
  assert.equal(
    getCompletedSubscriptionMonths(startedAt, new Date("2026-03-14T12:00:00.000Z")),
    1,
  );
  assert.equal(
    getCompletedSubscriptionMonths(startedAt, new Date("2026-03-15T12:00:00.000Z")),
    2,
  );
});
