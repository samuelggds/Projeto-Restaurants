...
test('emite acesso de visitante restrito ao pedido e publicId legado', () => {
...
test('emite token compacto para publicId UUID e valida no mesmo pedido', () => {
...
test('recusa reutilizar token compacto em outro pedido', () => {
