...
const router = Router();
router.post("/", authMiddleware, staffMiddleware, billingMiddleware, (req, res) => CreateTableController.handle(req, res));
router.get("/", authMiddleware, staffMiddleware, (req, res) => ListTableController.handle(req, res));
router.get("/:id", authMiddleware, staffMiddleware, (req, res) => GetTableByIdController.handle(req, res));
router.put("/:id", authMiddleware, staffMiddleware, (req, res) => UpdateTableController.handle(req, res));
router.patch("/:id", authMiddleware, staffMiddleware, (req, res) => DeactivateTableController.handle(req, res));
