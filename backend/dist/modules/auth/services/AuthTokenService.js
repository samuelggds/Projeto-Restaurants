...
import { getJwtExpiresIn, getJwtRefreshExpiresIn, getJwtRefreshSecret, getJwtSecret, } from "../../../config/auth.js";
...
function normalizePayload(payload) {
    return {
        ...
        restaurantId: payload.restaurantId === null || payload.restaurantId === undefined
            ? null
...
class AuthTokenService {
    ...
    async createRefreshToken(payload) {
        ...
        const exp = decoded && typeof decoded !== "string"
    ...
    async rotateRefreshToken(refreshToken) {
        ...
        const restaurantId = decoded.restaurantId === null || decoded.restaurantId === undefined
            ? null
