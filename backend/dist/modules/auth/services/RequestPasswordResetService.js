        ...
        if (transporter) {
            ...
            try {
                ...
                if (isBasicAuthDisabledError(error)) {
                    throw new Error("Falha no SMTP: o provedor bloqueou login por usuario/senha (basic auth). Configure SMTP_AUTH_TYPE=oauth2 com credenciais OAuth2 ou use um provedor com app password.");
                }
                throw error;
            }
        }
