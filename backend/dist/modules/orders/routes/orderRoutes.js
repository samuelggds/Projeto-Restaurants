...
router.patch("/:id/confirm-payment", authMiddleware, staffMiddleware, (req, res) => {
...
router.post("/:id/request-payment-confirmation-pin", authMiddleware, staffMiddleware, (req, res) => {
    RequestOrderPaymentConfirmationPinController.handle(req, res);
});
router.patch("/:id/confirm-payment-with-pin", authMiddleware, staffMiddleware, (req, res) => {
