...
import { PaymentMethod, TableSessionStatus, } from "@prisma/client";
...
class CreateOrderService {
    ...
    async execute({ userId, restaurantId, userRestaurantId, tableSessionId, tableSessionTableId, type, paymentMethod, paid, pixPaymentId, paymentProof, observation, customerName, customerCpf, customerPhone, tableId, items, address, number, district, city, state, zipCode, paymentProofImage, complement, }) {
