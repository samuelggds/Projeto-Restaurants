...
import { addOrderIssueMessage, ensureOrderIssueThread, getOrderIssueThread, toOrderIssueThreadPayload, } from "./orderIssueChatStore.js";
class ReplyOrderIssueService {
    async execute({ orderId, restaurantId, adminUserId, replyMessage, }) {
        ...
        await ensureOrderIssueThread({
            ...
            itemsSummary: Array.isArray(existingThread.itemsSummary)
                ? existingThread.itemsSummary
                : [],
        });
